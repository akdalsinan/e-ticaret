...
function Sepet({ sepetArray }) {
  var toplam = 0;

  for (let i = 0; i < sepetArray.length; i++) {
    toplam = sepetArray[i].price + toplam;
  }
  ...
  return (
    <div style={{ marginTop: "200px", display: "flex" }}>
      ...
      <div className="sepettekiTutar">
        <h1>Sipariş Özeti</h1>
        <h3>Ürünün Toplamı: {toplam} TL </h3>
        {/* <h3>kargo ücreti: 19.99 TL </h3>
        <h3>toplam tutar: {toplam + 19.99} TL</h3> */}

        {toplam > 1000 ? (
          <div>
            <h3 style={{ textDecoration: "line-through 3px red" }}>
              Kargo Ücreti:19.99 TL{" "}
            </h3>
          ...
          <div>
            <h3>
              Kargo Ücreti:19.99 TL{" "}
              <Tooltip  title="Sepetini 1000 TL'ye tamamla kargo bedava">
                <InfoCircleOutlined />
              </Tooltip>{" "}
            </h3>
            <h3>Toplam Tutar: {toplam + 19.99} TL </h3>
